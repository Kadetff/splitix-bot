...
async def cmd_webapp(message: Message):
    ...
    try:
        ...
        # ReplyKeyboardMarkup работает в групповых чатах без ограничений
        ...
        # Разные сообщения для групповых и личных чатов
        if message.chat.type == ChatType.PRIVATE:
            text = "Нажмите на кнопку ниже, чтобы открыть мини-приложение SplitCheck прямо в Telegram:"
        else:
            text = "🌐 Нажмите на кнопку клавиатуры ниже, чтобы открыть мини-приложение SplitCheck.\n\n" \
                   "Внимание: Эта кнопка будет доступна всем участникам группы, а не только вам."
